...
#define Encoder_TASK_PRIO 6
#define Encoder_TASK_SIZE 512
static TaskHandle_t EncoderTask_Handler;
...
void start_task(void *pvParameters)
{
    ...
    xTaskCreate((TaskFunction_t)EcoderTask,
                (const char *)"EcoderTask",
                (uint16_t)Encoder_TASK_SIZE,
                (void *)NULL,
    ...
    //             (TaskHandle_t *)&UserTask_Handler);
        ...
        xTaskCreate((TaskFunction_t)WheelTask,
                (const char *)"WheelTask",
                (uint16_t)Wheel_STK_SIZE,
                (void *)NULL,
